...
int Player::getDef(){
    return std_def + getVit() / 2 + (shieldIndex > -1 ? shield[shieldIndex].shield_stat[1]:0);
}
int Player::getAgi(){
...
void Game::initPlayingVariables(){
    ...
    damageText.setFillColor(Color::Black);
    damageText.setOutlineColor(Color::White);
    ...
    switch(dunStates){
        ...
        case 4:
            if(fightTurn == 0){
                ...
                damageText.setString("-" + to_string(playerDamage));
                damageText.setOrigin(getObjWidth(damageText) / 2,getObjHeight(damageText) / 2);
                damageText.setPosition(D_monCharS.getPosition().x,D_monCharS.getPosition().y - 170);
            }
            else if(fightTurn == 1){
                ...
                damageText.setString("-" + to_string(monsterDamage));
                damageText.setOrigin(getObjWidth(damageText) / 2,getObjHeight(damageText) / 2);
                damageText.setPosition(D_playerChar.getPosition().x,D_playerChar.getPosition().y - 170);
            }
            dunStates = 9;
            break;
        case 5:
        ...
        case 6:
            ...
            break;
        case 9:
            this->gameWindow->draw(damageText);
            attackDelay(10);
    };
...
void Game::attackDelay(unsigned int time){
    totalTime += deltaTime;
...
void Game::setItemStat(){
    ...
    accessory[3].name = "Ninja necklace";  accessory[3].price = 130; accessory[3].Des = "AGI + 7\nATK + 10\nLUK + 3\nSTR  -2\nVIT  0"; accessory[3].extra_agi = 7;accessory[3].extra_atk = 10;accessory[3].extra_luck = 3;accessory[3].extra_str = -2;accessory[3].extra_vit = 0;
    ...
    accessory[7].name = "Blood crystal";                             accessory[7].Des = "AGI + 10\nATK + 0\nLUK + 5\nSTR  -2\nVIT 0"; accessory[7].extra_agi = 10;accessory[7].extra_atk = 0;accessory[7].extra_luck = 5;accessory[7].extra_str = -2;accessory[7].extra_vit = 0;
